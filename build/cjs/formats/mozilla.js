...
class Mozilla {
    constructor(codeFilter = ["CKA_TRUST_ALL"], { url = Mozilla.URL, timeout = Mozilla.TIMEOUT, } = {}) {
        this.attributes = [];
        this.certText = null;
        this.curIndex = 0;
        this.url = url;
    ...
    getByTrustValue(data, trustVal) {
        ...
        if (data) {
            ...
            let res = sync_request_1.default("GET", this.url, { "timeout": this.timeout, "retry": true, "headers": { "user-agent": "nodejs" } });
        ...
        let certs = [];
        let ncc_trust = [];
        while (this.curIndex < ((_b = (_a = this.certText) === null || _a === void 0 ? void 0 : _a.length) !== null && _b !== void 0 ? _b : 0)) {
        ...
        for (let cert of certs) {
            ...
            for (let i in ncc) {
                ...
                if (m && m[1] !== "STEP_UP_APPROVED" && ncc[i] === trustVal)
                    (_c = tl_cert.trust) === null || _c === void 0 ? void 0 : _c.push(m[1]);
            }
    ...
    emptyTrustFilter(item, index) {
        var _a, _b;
        if ((_b = (_a = item.trust) === null || _a === void 0 ? void 0 : _a.length) !== null && _b !== void 0 ? _b : 0 > 0)
            return true;
        else
            return false;
    }
...
Mozilla.URL = "https://hg.mozilla.org/mozilla-central/raw-file/tip/security/nss/lib/ckfw/builtins/certdata.txt";
Mozilla.TIMEOUT = 1e4;
