...
class EUTL {
    ...
    fetchAllTSLs() {
        ...
        while (toProcess.length !== 0) {
            ...
            let tlsBody;
            try {
                res = sync_request_1.default("GET", url, { "timeout": this.timeout, "retry": true, "headers": { "user-agent": "nodejs" } });
            ...
            for (let pointer of eutl.SchemaInformation.Pointers) {
                if ((((_a = pointer.AdditionalInformation) === null || _a === void 0 ? void 0 : _a.MimeType) === "application/vnd.etsi.tsl+xml") &&
                ...
                for (let tSPService of trustServiceProvider.TSPServices) {
                    for (let cert of tSPService.X509Certificates) {
                        tl.AddCertificate({
                            ...
                            operator: (_a = trustServiceProvider.TSPName) === null || _a === void 0 ? void 0 : _a.GetItem("en"),
                            source: "EUTL",
                            evpolicy: []
                        });
                    }
...
exports.EUTL = EUTL;
EUTL.URL = "https://ec.europa.eu/information_society/policy/esignature/trusted-list/tl-mp.xml";
EUTL.TIMEOUT = 1e4;
...
class TrustServiceStatusList extends XmlObject {
    ...
    CheckSignature() {
        ...
        let xmlSignature = tslib_1.__classPrivateFieldGet(this, _element).getElementsByTagNameNS(XmlDSigJs.XmlSignature.NamespaceURI, "Signature");
        let sxml = new XAdES.SignedXml(tslib_1.__classPrivateFieldGet(this, _element).ownerDocument);
...
class SchemeInformation extends XmlObject {
    ...
    LoadXml(value) {
        ...
        if ((value.localName === XmlTrustServiceStatusList.ElementNames.SchemeInformation) && (value.namespaceURI === XmlTrustServiceStatusList.NamespaceURI)) {
            ...
            this.Version = +((_a = value.childNodes[i].textContent) !== null && _a !== void 0 ? _a : 0);
            ...
            this.SequenceNumber = +((_b = value.childNodes[i].textContent) !== null && _b !== void 0 ? _b : 0);
    ...
    LoadXml(value) {
        ...
        if ((value.localName === XmlTrustServiceStatusList.ElementNames.OtherTSLPointer) && (value.namespaceURI === XmlTrustServiceStatusList.NamespaceURI)) {
            ...
            for (let j = 0; j < serviceDigitalIdentities.length; j++) {
                if (serviceDigitalIdentities[j].nodeType !== exports.XmlNodeType.Element)
                    continue;
                let elsX509 = serviceDigitalIdentities[j].getElementsByTagNameNS(XmlTrustServiceStatusList.NamespaceURI, XmlTrustServiceStatusList.ElementNames.X509Certificate);
                ...
                if (XmlCore.isElement(node)) {
                    switch (node.localName) {
                        ...
                        case XmlTrustServiceStatusList.ElementNames.SchemeTypeCommunityRules:
                            let elements = node.getElementsByTagNameNS(XmlTrustServiceStatusList.NamespaceURI, XmlTrustServiceStatusList.ElementNames.URI);
