...
class TrustedList {
  ...
  toJSON() {
    let res = [];
    for (let cert of this.Certificates) res.push(cert);
    return res;
  }
  concat(tl) {
    if (tl) this.m_certificates = this.Certificates.concat(tl.Certificates);
    return this;
  }
  ...
  toString() {
    ...
    for (let cert of this.Certificates) {
      ...
      if (
        (_b =
          (_a = cert.evpolicy) === null || _a === void 0
            ? void 0
        ...
        res.push(
          "EV OIDs: " +
            ((_c = cert.evpolicy) === null || _c === void 0
              ? void 0
              : _c.join(", "))
        );
