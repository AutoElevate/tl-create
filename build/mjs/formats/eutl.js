...
export class TrustServiceStatusList extends XmlObject {
    ...
    LoadXml(value) {
        ...
        if ((value.localName === XmlTrustServiceStatusList.ElementNames.TrustServiceStatusList) && (value.namespaceURI === XmlTrustServiceStatusList.NamespaceURI)) {
            ...
            __classPrivateFieldSet(this, _element, value);
        }
        else
    ...
    CheckSignature() {
        ...
        let xmlSignature = __classPrivateFieldGet(this, _element).getElementsByTagNameNS(XmlDSigJs.XmlSignature.NamespaceURI, "Signature");
        let sxml = new XAdES.SignedXml(__classPrivateFieldGet(this, _element).ownerDocument);
